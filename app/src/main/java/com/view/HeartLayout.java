...
import com.util.AbstractPathAnimator;
import com.util.PathAnimator;
...
public class HeartLayout extends RelativeLayout implements View.OnClickListener{
    ...
    private void findViewById(Context context){
        ...
        bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.flash_on);
    ...
    private static int[] drawableIds = new int[]{R.drawable.flash_on, R.drawable.flash_off,R.drawable.flash_on, R.drawable.flash_off,R.drawable.flash_on, R.drawable.flash_off,R.drawable.flash_on, R.drawable.flash_off};
